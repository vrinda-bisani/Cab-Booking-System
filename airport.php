...
$sqlcheck="Select * from airport where cartype='$cartype' and car='$car' and substring(date,1,10)='$date1'";
...
$sql = "INSERT INTO airport values('$uname','$name','$city','$date','$cartype','$car','$address','$amount','$id')";  
if(mysqli_query($conn, $sql)){  
    if(isset($_GET['airportbook'])){
